      ...
      content:(
        <div>
          ...
          <div className="formula">
            ...
            <span className="fc"># Final prediction (sigmoid again):</span>{"\n"}
      ...
      content:(
        <div>
          ...
          <div className="formula">
            ...
            <span className="fc"># Through sigmoid activation in hidden layer:</span>{"\n"}
...
export default function BackpropTutorial() {
